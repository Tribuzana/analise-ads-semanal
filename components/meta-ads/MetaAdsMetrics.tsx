...
interface MetaAdsMetricsProps {
  campaigns: CampaignData[]
  comparisonCampaigns?: CampaignData[]
}

export function MetaAdsMetrics({ campaigns, comparisonCampaigns }: MetaAdsMetricsProps) {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <MetricCard
        ...
        change={hasComparison ? calculateDelta(cpa, previousCpa) : undefined}
        compareValue={hasComparison ? formatCurrency(previousCpa) : undefined}
      />
    </div>
  )
}
